<div id="wrapper">
    <div class="navbar-inverse">
        ...
        <ul class="nav navbar-nav side-nav">
            <li ><a href="admin/index"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><a href="admin/questform"><i class="fa fa-edit"></i> Create Quest</a></li>
            <li><a href="admin/partnerform"><i class="fa fa-edit"></i> Partner Information</a></li>
        </ul>
    </div>
